...
class Classifier:
    def __init__(self):
        ...
        self.DATASETS_DIR = "C:\\Users\Gianpaolo Patierno\\PycharmProjects\\pyton yoga classificator\\training_set"
        self.TEST_DIR = "C:\\Users\\Gianpaolo Patierno\\PycharmProjects\\pyton yoga classificator\\test_set"
    ...
    def feature_vector(self):
        ...
        h5f_data = h5py.File('C:\\Users\\Gianpaolo Patierno\\PycharmProjects\\pyton yoga classificator\\datasets_file\\data.h5',
                             'w')
        h5f_data.create_dataset('dataset_1', data=np.array(rescaled_features))

        h5f_label = h5py.File(
            'C:\\Users\\Gianpaolo Patierno\\PycharmProjects\\pyton yoga classificator\\datasets_file\\labels.h5', 'w')
    ...
    def feature_to_string(self):
        ...
        h5f_data = h5py.File('C:\\Users\\Gianpaolo Patierno\\PycharmProjects\\pyton yoga classificator\\datasets_file\\data.h5',
                             'r')
        h5f_label = h5py.File(
            'C:\\Users\\Gianpaolo Patierno\\PycharmProjects\\pyton yoga classificator\\datasets_file\\labels.h5', 'r')
    ...
    def training_test(self):
        ...
        train_X, test_X, train_Y, test_Y = train_test_split(global_features, global_labels,
                                                            test_size=0.25,
                                                            random_state=42)
    ...
    def testing_images(self, forest_grid_search):
        ...
        for test_name in self.test_labels:
            ...
            for img in tqdm(os.listdir(DIR_TEST)):
                ...
                glob_features_p = extract_feature.extract(img)

                prediction = forest_grid_search.predict(glob_features_p.reshape(1, -1))[0]

                cv.putText(img, 'Predict Position: {}'.format(self.train_labels[prediction]), (20, 30),
                           cv.FONT_HERSHEY_SIMPLEX, 1.0, (255, 116, 55), 3)

                cv.putText(img, 'Actual Position: {}'.format(str(label_test)), (20, 60),
                           cv.FONT_HERSHEY_SIMPLEX, 1.0, (255, 116, 55), 3)
